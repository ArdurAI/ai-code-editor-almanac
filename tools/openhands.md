...
- **Latest release:** `cloud-1.46.2` (2026-07-15): Cloud patch restores cross-domain PostHog tracking by aligning client/server `distinct_id` handling.
- **Adoption signal:** GitHub stars moved from 80,505 to 81,055 (+550). Track 81,055 as the current monitoring baseline because this crossed the >500 daily-change threshold.

### Daily monitoring update — 2026-07-12

- **Latest release:** `cloud-1.46.0` (2026-07-10): enriches final archive manifests and removes initial snapshots, makes enterprise BYOR key-alias patterns configurable, and fixes budget-alert SMTP guidance, conversation cost-event cascade deletes, database pooling behavior, and observability context metadata preservation.
...
OpenHands is the open-source alternative to Devin — a fully autonomous AI software engineering agent that runs in Docker-sandboxed environments. Its 81K+ GitHub stars (under the All-Hands-AI organization, formerly OpenDevin) make it the most popular open-source autonomous coding agent by a wide margin. For teams that want Devin-like autonomous capabilities without vendor lock-in or proprietary pricing, OpenHands is the natural choice.
...
**Development activity**: Extremely active. [OpenHands/OpenHands](https://github.com/All-Hands-AI/OpenHands) (redirected from All-Hands-AI/OpenHands) has **81,055 stars**, 10,076 forks, 363 open issues. Last pushed: July 17, 2026. Created March 2024 (as OpenDevin) — explosive growth.
